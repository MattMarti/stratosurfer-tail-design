...
class AirfoilDesignFrame:
    ...
    def __init__(self, gui_handle, parent_frame:tk.Frame, design_data:DesignData):
        ...
        self.entries = {}
        self._add_entry(parent_frame, Options.m, f"{self.airfoil_design_data.m}")
        self._add_entry(parent_frame, Options.p, f"{self.airfoil_design_data.p}")
        self._add_entry(parent_frame, Options.t, f"{self.airfoil_design_data.t}")
